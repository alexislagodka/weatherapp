...
class SideBarSearchForm extends React.Component {
    ...
    render(){
        ...
        return <div className={styles.sidebarSearchForm} id="sidebarSearchForm">
            ...
            <form className={styles.searchForm} autoComplete="off" >
                ...
                {
                    this.state.woeid === "" ? "" :  <button  className={styles.searchButton} name="search" onClick={e => this.handleSearch(e) }>
                        <p>Search</p>
                    </button>
                }

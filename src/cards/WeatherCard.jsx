...
class WeatherCard extends React.Component {
    ...
    render () {
        const {unit, weatherDayInfos} = this.props;
        return <div className="weatherCard">
            ...
            <div className ="tempInterval" style={{display:"flex", flexDirection:"row", justifyContent:"space-around" }}>
                ...
                {unit===0 ? <div style={{color:"#E7E7EB"}}>{parseInt(weatherDayInfos.min_temp)}°C</div> : <div style={{color:"#E7E7EB"}}>{parseInt(((weatherDayInfos.min_temp)*(9/5))+32)}°F</div>}
                
                {unit===0 ? <div style={{color:"#A09FB1"}}>{parseInt(weatherDayInfos.max_temp)}°C</div> : <div style={{color:"#A09FB1"}}>{parseInt(((weatherDayInfos.max_temp)*(9/5))+32)}°F</div>}
